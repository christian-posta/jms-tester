...
public class JndiJmsConnectionProvider extends DefaultJMSConnectionProvider {
  /**
 * @uml.property  name="jndiCtxtFactory"
 * @uml.associationEnd  
 */
private JndiInitialContextFactory jndiCtxtFactory       = null;
  ...
  @Override
	public ConnectionFactory getConnectionFactory() throws Exception{
        ...
        ConnectionFactory factory = (ConnectionFactory) ctxt.lookup(getConnectionFactoryName());
        return factory;
	}
    ...
    public final void setJndiInitialContextFactory(final JndiInitialContextFactory factory) {
