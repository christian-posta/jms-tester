...
public class AsyncProducer extends AsyncClient implements Runnable, MessageListener {
	
    private static final transient Log LOG = LogFactory.getLog(AsyncProducer.class);
